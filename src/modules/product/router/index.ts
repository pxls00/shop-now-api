...
router.patch(`${config.moduleRouteBaseURL}/:${config.moduleRouteItemIdURL}`, [
  checkFieldLengthBodyRequest('name', 5, 255),
  checkFieldIsNumbericBodyRequest('price'),
  checkFieldIsNumbericBodyRequest('sale_price'),
  checkFieldIsBooleanRequest('in_sale'),
...
router.delete(`${config.moduleRouteBaseURL}/:${config.moduleRouteItemIdURL}`, controller.deleteProductById)
